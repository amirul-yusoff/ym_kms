...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
		{{Form::model($invoice, array('route' => array('subcon.invoice.update', $invoice->CreditorInvoiceID), 'method' => 'PUT', 'files'=> true))}}
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						<div class="form-group row">
							...
							<div class="col-sm-8 ">
								{{Form::select('workorder_id', $workorderLists['Select'], ['class'=>'form-control form-control-sm workorder', 'required', 'placeholder'=>'Select WorkOrder No.'])}}
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								@if (isset($invoice->work_order_document))
									<img src="{{ route('subcon.self-service.get-document-small', $invoice->work_order_document) }}" style="float:left; padding-right: 50px">
								@endif
