...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="">
		{{ Form::open(['url' => $url,'id' => 'create', 'enctype'=>"multipart/form-data"]) }}
				...
				<div class="ibox">
					...
					<div class="ibox-content">
                        <div class="form-group row {{ $errors->has('employee_name') ? 'has-error' : '' }}">
							...
							<div class="col-sm-8 ">
                                {{Form::text('employee_name', null, ['class'=>'form-control form-control-sm', 'required'])}}
                        ...
                        <div class="form-group row {{ $errors->has('roles') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-8 ">
                                {{Form::select('roles[]', $roleList, null,['multiple' => true, 'class'=>"chosen-select", 'required', 'style'=>"width:350px;", 'tabindex'=>"4"])}}
                                @if($errors->has('roles'))
                                    <em class="invalid-feedback">
                                        {{ $errors->first('roles') }}
                                    </em>
                        ...
                        <div class="form-group row {{ $errors->has('password') ? 'has-error' : '' }}">
                            <label for="password" class="col-sm-4 form-control-label"><span class="required">*</span>{{ trans('cruds.member.fields.password') }}</label>
                            <div class="col-sm-8 ">
                        ...
                        <div class="form-group row {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
                            <label for="password_confirmation" class="col-sm-4 form-control-label"><span class="required">*</span>{{ trans('cruds.member.fields.confirmation') }}</label>
                            <div class="col-sm-8 ">
