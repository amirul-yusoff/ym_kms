			...
			<div class="float-e-margins">
				<div class="ibox-title">
					...
					<div class="ibox-content">
        				<div class="row">
							{{ Form::open(array('route' => 'my-invoice-subcon.store', 'files' => true))}}
							<div class="col-sm-6">
								<div class="form-group">
									<label for="loc_date" class="col-sm-4 control-label">LOC Submission Date :</label>
									<div class="col-sm-8">
										{{ Form::text('loc_date', $now, ['class' => 'form-control datepicker']) }}
									</div>
								</div><br><br>
							</div>
							<div class="col-sm-6">
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="wo_number" class="form-control" id="wo_number" required>
											<option value="">Please Select Work Order</option>
											@foreach ($woData as $wolist)
												<option value="{{$wolist->ID}}">{{$wolist->WorkOrderNumber}}</option>
											@endforeach
										</select>
									</div>
								</div><br><br>
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label for="files[]" class="col-sm-2 control-label">Files (LOC,JMS,BQ):</label>
									<div class="col-sm-10">
