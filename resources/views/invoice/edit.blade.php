			...
			<div class="float-e-margins">
				<div class="ibox-title">
					...
					<div class="ibox-content">
        				<div class="row">
							{{ Form::open(array('route' => ['my-invoice-subcon.update', $data->id], 'files' => true))}}
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-8">
										{{ Form::text('loc_date', $data->loc_date, ['class' => 'form-control datepicker']) }}
									</div>
								</div><br><br>
							</div>
							<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="wo_number" class="form-control" id="wo_number" required>
											<option value="{{$data->wo_id}}">{{$data->wo_number}}</option>
