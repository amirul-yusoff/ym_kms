            ...
            <div class="float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            {{ Form::model($data, ['route' => ['my-invoice-supplier.update', $data->id], 'method' => 'PUT', 'files' => true]) }}
                            <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="po_number[]" class="form-control" id="po_number" multiple required>
                                            ...
                                            @foreach ($poData as $polist)
                                                <option value="{{$polist->po_number}}" {{ in_array($polist->po_number, $data->getPO->pluck('po_number')->toArray()) ? 'selected' : '' }}>{{$polist->po_number}} || {{$polist->vendor}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div><br><br>
